...
const  formData = {Name,PgName,Mobile,Whatsapp,PgType,RoomAvailable,Location};
console.log(formData);

 axios.post(process.env.REACT_OWNER_API,formData)
 .then((response)=>{
    ...
    <div className="contact-form-wrapper">
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-item">
          <label>PgName:</label>
          <input type="text" onChange={(e) => setPgName(e.target.value)}  required/>
        ...
        <div className="form-item">
        <label>Pg Type:</label>
          <input type="text" onChange={(e) => setPgType(e.target.value)}  required/>
         
        </div>
        <div className="form-item">
        <label>RoomAvailable:</label>
          <input type="number" onChange={(e) => setRoomAvailable(e.target.value)} required/>
